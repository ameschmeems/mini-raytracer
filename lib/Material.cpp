...
Material::Material(const Vector3 &ambient, const Vector3 &specular, const Vector3 &reflectance, float phong_exponent)
	: ambient { ambient }, _specular { specular }, _reflectance { reflectance }, _phong_exponent { phong_exponent }
{
}
